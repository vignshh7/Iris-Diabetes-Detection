...
class Config:
    ...
    DIABETIC_IMAGE_DIR = 'dataset/diabetic/'
    CONTROL_IMAGE_DIR = 'dataset/control/'
    # --- NEW: Add the input directory for testing images ---
    TESTING_IMAGE_DIR = 'dataset/testing/'

    # These folders contain the corresponding accurate IRIS MASKS in .png format
    DIABETIC_IRIS_MASK_DIR = 'test_results_masks/diabetic/'
    CONTROL_IRIS_MASK_DIR = 'test_results_masks/control/'
    # --- NEW: Add the input directory for testing iris masks ---
    TESTING_IRIS_MASK_DIR = 'test_results_masks/testing/'

    # --- Output Directories ---
    # Define separate output folders for the generated pancreas masks
    OUTPUT_DIABETIC_PANCREAS_DIR = 'dataset/pancreas_masks_for_training/diabetic/'
    OUTPUT_CONTROL_PANCREAS_DIR = 'dataset/pancreas_masks_for_training/control/'
    # --- NEW: Add the output directory for testing pancreas masks ---
    OUTPUT_TESTING_PANCREAS_DIR = 'dataset/pancreas_masks_for_testing/testing/'
