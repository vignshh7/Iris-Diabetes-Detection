...
def create_directories():
    ...
    directories = [
        ...
        TESTING_DIR, TESTING1_DIR, MASKS_DIR, PANCREAS_MASKS_TRAIN_DIR,
        PANCREAS_CONTROL_DIR, PANCREAS_DIABETIC_DIR, PANCREAS_MASKS_TEST_DIR,
        PANCREAS_TESTING_DIR, PANCREAS_TESTING1_DIR, TEST_RESULTS_MASKS_DIR,
        TEST_RESULTS_CONTROL_MASKS, TEST_RESULTS_DIABETIC_MASKS,
